...
**INFO 7390: Art and Science of Data - Final Project**  
**Author:** Abhinav Kumar Piyush  
**University:** Northeastern University  

> **Option 1: AI-Powered Retrieval-Augmented Generation (RAG) Application**
...
```bash
git clone https://github.com/YOUR_USERNAME/h1b-rag-project.git
cd h1b-rag-project
```
